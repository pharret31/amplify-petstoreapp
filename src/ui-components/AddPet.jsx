...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeOneFiveNineTwoSixNineNineValue,
    setTextFieldThreeOneFiveNineTwoSixNineNineValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveNineTwoSevenZeroSixValue,
    setTextFieldThreeOneFiveNineTwoSevenZeroSixValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveNineTwoSevenOneThreeValue,
    setTextFieldThreeOneFiveNineTwoSevenOneThreeValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeOneFiveNineTwoSixNineNineValue,
      color: textFieldThreeOneFiveNineTwoSevenZeroSixValue,
      image: textFieldThreeOneFiveNineTwoSevenOneThreeValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeOneFiveNineTwoSevenTwoOneOnClick = useDataStoreUpdateAction({
    fields: {
      name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
      age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      breed: textFieldTwoNineSevenSixSixNineTwoFourValue,
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveNineTwoSixNineNineValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveNineTwoSixNineNineValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31592699")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveNineTwoSevenZeroSixValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveNineTwoSevenZeroSixValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31592706")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveNineTwoSevenOneThreeValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveNineTwoSevenOneThreeValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31592713")}
          ></TextField>
        </Flex>
        <Divider
          height="1px"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeOneFiveNineTwoSevenTwoOneOnClick();
            }}
            {...getOverrideProps(overrides, "Button31592721")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
